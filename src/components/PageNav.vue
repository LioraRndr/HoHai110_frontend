<template>
  <!-- 桌面端侧边栏 -->
  <div class="side-nav" :class="[{ hidden: !isVisible }, theme]">
  ...
  <!-- 移动端底部导航栏 -->
  <div class="mobile-nav" :class="[{ hidden: !isVisible }, theme]">
  ...
  <button
    ...
    :class="[{ visible: showBackToTop }, theme]"
    @click="scrollToTop"
  >
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
      <path d="M12 19V5M5 12l7-7 7 7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
.side-nav.dark .nav-item {
  color: rgba(255, 255, 255, 0.8);
}

.side-nav.dark .nav-item:hover {
  background: rgba(255, 255, 255, 0.1);
  border-color: rgba(255, 255, 255, 0.2);
  color: white;
}

.side-nav.dark .nav-item.active {
  background: linear-gradient(135deg, rgba(65, 105, 225, 0.9) 0%, rgba(138, 43, 226, 0.9) 100%);
  color: white;
  box-shadow: 0 4px 16px rgba(65, 105, 225, 0.5);
}

.side-nav.dark .nav-label {
  background: rgba(10, 14, 26, 0.95);
  border: 1px solid rgba(255, 255, 255, 0.1);
}

.side-nav.dark .nav-label::after {
  border-left-color: rgba(10, 14, 26, 0.95);
}

.side-nav.dark .back-to-top:hover {
  background: linear-gradient(135deg, rgba(65, 105, 225, 0.9) 0%, rgba(138, 43, 226, 0.9) 100%);
  box-shadow: 0 4px 16px rgba(65, 105, 225, 0.5);
}
...
@media (max-width: 768px) {
  ...
  .mobile-nav.dark .mobile-nav-item {
    color: rgba(255, 255, 255, 0.8);
  }

  .mobile-nav.dark .mobile-nav-item:active {
    background: rgba(255, 255, 255, 0.1);
  }
  ...
  .mobile-nav.dark .mobile-nav-item.active .mobile-nav-icon {
    background: linear-gradient(135deg, rgba(65, 105, 225, 0.9) 0%, rgba(138, 43, 226, 0.9) 100%);
    box-shadow: 0 2px 12px rgba(65, 105, 225, 0.4);
  }

  .mobile-nav.dark .mobile-nav-label {
    color: rgba(255, 255, 255, 0.9);
  }

  .mobile-back-to-top.dark {
    background: linear-gradient(135deg, rgba(65, 105, 225, 0.95) 0%, rgba(138, 43, 226, 0.95) 100%);
    box-shadow: 0 4px 16px rgba(65, 105, 225, 0.5);
  }

  .mobile-back-to-top.dark:active {
    transform: scale(0.95);
  }
}
</style>
